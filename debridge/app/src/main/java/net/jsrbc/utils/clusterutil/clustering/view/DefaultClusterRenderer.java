...
package net.jsrbc.utils.clusterutil.clustering.view;
...
import net.jsrbc.R;
import net.jsrbc.utils.clusterutil.MarkerManager;
...
import net.jsrbc.utils.clusterutil.projection.Point;
import net.jsrbc.utils.clusterutil.projection.SphericalMercatorProjection;
import net.jsrbc.utils.clusterutil.ui.IconGenerator;
...
import static net.jsrbc.utils.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements
    ...
    private net.jsrbc.utils.clusterutil.ui.SquareTextView makeSquareTextView(Context context) {
        net.jsrbc.utils.clusterutil.ui.SquareTextView squareTextView =
                new net.jsrbc.utils.clusterutil.ui.SquareTextView(context);
